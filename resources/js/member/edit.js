...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // CREATE CROPPER IMAGE IF NOT EXISTING
    ...
    if (!cropImage) {
        ...
        preview.parentNode.insertBefore(cropImage, preview);
    }
    ...
    if (!cropBtn) {
        ...
        cropBtn.className = 'btn btn-outline-success btn-sm mt-2';

        cropBtn.innerText = 'Crop 2x2';
